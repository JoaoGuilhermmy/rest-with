package com.joaoguilhermmy.integrationtest.controllers.withYaml;
...
import io.restassured.config.EncoderConfig; // Novo import
import io.restassured.config.RestAssuredConfig; // Novo import
import io.restassured.filter.log.LogDetail;
import io.restassured.filter.log.RequestLoggingFilter;
import io.restassured.filter.log.ResponseLoggingFilter;
import io.restassured.http.ContentType; // Novo import
...
class PersonControllerYamlTest extends AbstractIntegrationTest {
    ...
    // Atualizado para o formato padrão do Spring Boot
    private static final String CONTENT_TYPE_YML = "application/yaml";
    ...
    void createTest() throws JsonProcessingException {
        ...
        specification = new RequestSpecBuilder()
                ...
                // Configuração ensinando o RestAssured a tratar YAML como texto
                .setConfig(
